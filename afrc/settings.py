"""
Django settings for afrc project.
"""
...
DATATYPE_LOCATIONS.append("afrc.datatypes")
FUNCTION_LOCATIONS.append("afrc.functions")
ETL_MODULE_LOCATIONS.append("afrc.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("afrc.search_components")
...
ROOT_URLCONF = "afrc.urls"
ROOT_HOSTCONF = "afrc.hosts"
...
# [{
#     'module': 'afrc.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = "afrc.wsgi.application"
